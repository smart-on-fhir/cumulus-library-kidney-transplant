...
def deprecated_make_pair() -> List[Path]:
    ...
    by_variable_cols = ['variable1', 'variable2', 'age_at_visit1']
    by_valueset_cols = ['valueset1', 'valueset2', 'age_at_visit1']
...
def make() -> List[Path]:
    """
    CUBE custom variables
    TODO: refactor and merge into `cube.py`
    """
