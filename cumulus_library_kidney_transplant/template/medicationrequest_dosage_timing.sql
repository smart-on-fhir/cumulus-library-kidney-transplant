create or replace view irae__medicationrequest_dosage_timing as
select  date(from_iso8601_timestamp(DI.timing.repeat.boundsperiod."start")) as timing_start_date,
