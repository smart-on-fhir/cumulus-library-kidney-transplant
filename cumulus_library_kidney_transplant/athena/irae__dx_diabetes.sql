create or replace view irae__dx_diabetes as 
 ...
 UNION select 'dx_diabetes_t1d' as valueset, system, code, display from 
 irae__dx_diabetes_t1d
 UNION select 'dx_diabetes_t2d' as valueset, system, code, display from 
 ...
 UNION select 'dx_diabetes_disorder' as valueset, system, code, display from 
