...
select distinct
        ...
        dn_code.display                 as lab_observation_display,
...
from    irae__cohort_study_population as study_population,
        ...
        core__observation_dn_code as dn_code
where   lab.system = dn_code.system
and     lab.observation_code =dn_code.code
and     study_population.encounter_ref = lab.encounter_ref
;