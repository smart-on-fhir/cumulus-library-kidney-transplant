...
# Bacterial Infection
echo "Bacterial Infection"
docker compose run --rm -it \
  cumulus-etl sample \
  <input folder with ndjson files from step 2 above> \
  --output ./samples/bacterial-infection.csv\
  --export-to ./samples/bacterial-infection/\
  --count 30 \
  --seed 07201869 \
  ...
  --select-by-word "Bacterial" \
  --select-by-word "Bacteria" \
  --select-by-word "Bacteremia" \
  --select-by-word "Gram stain" \
  --select-by-word "Gram staining" \
  --select-by-word "Gram positive" \
  --select-by-word "Gram negative" \
  --select-by-word "Gram-positive" \
  --select-by-word "Gram-negative" \
  --select-by-word "Antibiotics" \
  --select-by-word "Antibiotic" \
  --select-by-word "Resistance" \
  --select-by-word "Resistant" \
  --select-by-word "Strains" \
  --select-by-word "Strain" \
  --select-by-word "Variant" \
  --select-by-word "Enterococcus" \
  --select-by-word "Streptococcus" \
  --select-by-word "VRE" \
  --select-by-word "Klebsiella" \
  --select-by-word "Bacillus" \
  --select-by-word "Clostridium" \
  --select-by-word "Clostridioides" \
  --select-by-word "C. diff" \
  --select-by-word "C diff" \
  --select-by-word "C.diff" \
  --select-by-word "Cdiff" \
  --select-by-word "Escherichia" \
  --select-by-word "E.coli" \
  --select-by-word "E coli" \
  --select-by-word "E. coli" \
