...
docker compose run --rm -it \
  ...
  cumulus-etl sample \
  $SAMPLE_INPUT_FOLDER \
  --output /host/samples/other-notes.csv\
  --export-to /host/samples/other-notes/\
  --count 30 \
  --seed 07201869 \
