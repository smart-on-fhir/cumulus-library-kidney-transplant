create or replace view irae__rx_transplant as 
 select 'rx_atg' as subtype, system, code, display from 
 irae__rx_atg
 ...
 UNION select 'rx_sirolimus' as subtype, system, code, display from 
 irae__rx_sirolimus
