...
from cumulus_library_kidney_transplant.llm.builder import irae_donor_highlights as builder_module


@pytest.fixture()
def builder():
    return builder_module.IraeNlpDonorHighlightsBuilder()
...
def test_prepare_queries_appended_sql_is_valid(database, builder):
    ...
    valid_tables = {"irae__nlp_donor_gpt_oss_120b"}
